...
# --- NEW FIX: Added nogil=True to allow parallel execution ---
...
class mimo_cma_2x2(gr.sync_block):
    def __init__(self, mu=1e-4):
        ...
        # --- NEW FIX: Warm up Numba so it compiles BEFORE the USRP streams data ---
...
class dual_pole_rx(gr.top_block, Qt.QWidget):
    def __init__(self):
        ...
        ##################################################
        self.sps = 4
        self.samp_rate = 1e6  # RESTORED TO 1 MSps
        self.freq = 2.4e9  
        self.excess_bw = 0.35 
        ...
        # FAST NUMBA MIMO EQUALIZER INJECTED HERE
