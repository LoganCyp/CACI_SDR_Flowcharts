...
class dual_pole_rx(gr.top_block, Qt.QWidget):
    def __init__(self):
        ...
        # --- QPSK Path (0) ---
        # costas_0 -> Linear Equalizer (15 taps, CMA, 1 sps) -> decoder
        self.connect((self.costas_0,  0), (self.leq_qpsk,    0))
        self.connect((self.leq_qpsk,  0), (self.decoder_qpsk, 0))
